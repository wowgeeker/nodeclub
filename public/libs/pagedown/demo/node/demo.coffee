...
http.createServer((req, res) ->
  ...
  res.write "<h1>Enter Markdown</h1>\n" + "<form method='get' action='/'>" + "<textarea cols=50 rows=10 name='md'>" + markdown.replace(/</g, "&lt;") + "</textarea><br>" + "<input type='submit' value='Convert!'>" + "</form>"
  res.end "</body></html>"
  return
).listen 8000
